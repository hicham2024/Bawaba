...
.hero{width:100vw!important;max-width:none!important;min-height:clamp(620px,88vh,960px)!important;margin-inline:calc(50% - 50vw)!important;border-radius:0!important}.hero>img{width:100%!important;height:100%!important;object-fit:cover!important;object-position:center!important}@media(max-width:720px){.hero{min-height:78vh!important}}
.chapter-inline{padding:0 0 18px;margin:0 0 26px;border-bottom:1px solid var(--line)}.chapter-number{display:inline-block;color:#9b6b22;font-weight:800;font-size:.88rem;margin-bottom:5px}.chapter-inline h2{margin:0!important;color:var(--g)!important;font-size:clamp(1.8rem,4vw,2.65rem)!important;line-height:1.45}.chapter-sub{margin:7px 0 0;color:#697679;font-size:1rem}.chapter{scroll-margin-top:84px}.front,.refs{scroll-margin-top:84px}.hero-credit{position:absolute!important;bottom:14px;left:18px;right:18px;font-size:.63rem;color:rgba(255,255,255,.72);text-align:center;text-shadow:0 1px 4px rgba(0,0,0,.8)}.original-quote{display:block;margin-top:8px;padding-top:7px;border-top:1px solid rgba(113,93,54,.18);font-size:.73rem;line-height:1.6;color:#6d7475;font-weight:400;text-align:left}@media(max-width:720px){.chapter-inline h2{font-size:1.8rem!important}.chapter{padding-top:34px}.cover::before{width:100%;height:50%;bottom:auto}.cover::after{width:100%;height:50%;top:50%;right:0}.cover h1{font-size:3rem}.hero-credit{font-size:.55rem}.original-quote{font-size:.68rem}}`;
    ...
    efforts = efforts.replace("<body>", `<body>${articleNav}`);
    efforts = efforts.replace('<div class="note"><b>ملاحظة منهجية:</b> يستعمل المقال لفظ «الاسترجاع» لوصف الهدف المغربي كما يظهر في المصادر التاريخية. أما الوضع القانوني والسياسي المعاصر للمدينتين فهو محل خلاف بين المغرب وإسبانيا، ولا تحسمه هذه الوثائق التاريخية بمفردها.</div>', "");
    efforts = efforts.replace('<div class="note"><b>مرجع تمهيدي:</b> تاريخ احتلال سبتة سنة 1415 وانتقالها لاحقًا من البرتغال إلى إسبانيا موثق في الدراسات العامة عن التوسع البرتغالي في شمال إفريقيا. <a href="https://en.wikipedia.org/wiki/Portuguese_conquest_of_Ceuta" target="_blank" rel="noopener">فتح المرجع</a>.</div>', "");
    efforts = efforts.replace('<div class="evidence"><b>أهمية الواقعة:</b> هنا لم تكن محاولة استرجاع سبتة حصارًا مباشرًا للمدينة، بل استخدامًا لنتيجة عسكرية حاسمة في طنجة لفرض التزام بإعادتها إلى المغرب.</div>', "");
    efforts = efforts.replace('<p>للمراجعة العامة للواقعة: <a href="https://pt.wikipedia.org/wiki/Desastre_de_T%C3%A2nger" target="_blank" rel="noopener">Desastre de Tânger</a>. كما يعرض مؤلف أكاديمي من جامعة كامبريدج أن إنريكي اضطر إلى التعهد بتسليم سبتة مقابل المرور الآمن، مع إبقاء فرناندو رهينة لدى المرينيين.</p>', '<p>يعرض مؤلف أكاديمي صادر عن جامعة كامبريدج أن إنريكي اضطر إلى التعهد بتسليم سبتة مقابل المرور الآمن، مع إبقاء فرناندو رهينة لدى المرينيين.</p>');
